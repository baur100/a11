...
public class App {
    public static void main(String[] args) {
        ...
        Keyboard keyboard1 =new Keyboard("Logitech","MK335",true);
        ...
        Computer computer1= new Computer(mouse1, keyboard1,monitors,mysystemBlock1);
        ...
        Keyboard keyboard2 =new Keyboard("Azio","KB505U",false);
        ...
        Computer computer2=new Computer(mouse2, keyboard2,monitors1,mysystemBlock2);

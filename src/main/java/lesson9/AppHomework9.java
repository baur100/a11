...
//    print object info using print-out method
    ...
    public static void main(String[] args) {
        ...
        bestbuy.setName("Best Buy");
        bestbuy.setType("Electronics");
        bestbuy.setStockValue(120);
        bestbuy.printStoreInfo();

        Store homegoods = new Store("Home Goods","home decor", 55 );
        homegoods.printStoreInfo();

...
public class MainPageFactoryTest {
    ...
    public void loginTest_loginWithCorrectCredentials_mainPageOpened(){
        ...
        loginPage.open("https://www.apollopros.com/member/login.aspx");
        MainPage mainPage = loginPage.loginToApp("klingergk@mail.com","GeorgeSmith123!");
    ...
    public void loginTest_loginWithIncorrectCredentials_errorFrame(){
        LoginPageFactory loginPage = new LoginPageFactory(driver);
        loginPage.open("https://www.apollopros.com/member/login.aspx");
        loginPage.loginToApp("klingergk@mail.com","GeorgeSmith123!");

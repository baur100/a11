...
public class GetPet1 {
    private long petId;
    private Pet1 pet;

    @BeforeMethod
    public void createPet(){
        pet = TestDataGenerator1.generateRandomPet();
    ...
    public void getPetById(){
        ...
        Pet1 petResponse = jsonPath.getObject("$",Pet1.class); // "$" means root, it will get whole object
    ...
    public void updatePet(){
        Pet1 updatedPet = TestDataGenerator1.generateRandomPet();
        ...
        Response response =  given()
                ...
                .response();
        JsonPath jsonPath = response.jsonPath();
        Pet1 petResponse = jsonPath.getObject("$",Pet1.class);
